    ...
    <div className="grid grid-cols-[repeat(auto-fit,_minmax(300px,_1fr))] gap-4 p-4">
        <div className="w-full">
          <div className="relative mb-2 w-full pt-[56%]">
            ...
            <span className="absolute bottom-1 right-1 inline-block rounded bg-black bg-opacity-70 font-medium px-1.5 text-white text-sm">20:45</span>
          </div>
          <div className="flex gap-x-2">
            ...
            <div className="w-full">
              ...
              <p className="flex text-sm text-gray-600">10.3k Views · 44 minutes ago</p>
        ...
        <div className="w-full">
          ...
          <div className="flex gap-x-2">
            ...
            <div className="w-full">
              ...
              <p className="flex text-sm text-gray">14.5k Views · 7 hours ago</p>
              <p className="text-sm text-gray">API Builder</p>
            </div>
          </div>
        </div>
        <div className="w-full">
