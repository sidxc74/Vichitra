...
import { logoutApi } from '../../api/users.api';
...
function Sidebar({path}) {
  ...
  return (
    <aside
    className={`group fixed inset-x-0 bottom-0 z-40 w-full shrink-0 border bg-white px-2 py-2 sm:absolute sm:inset-y-0 sm:max-w-[70px] sm:border-r sm:border-t-0 sm:py-6 sm:hover:max-w-[250px] ${!path ? 'lg:sticky lg:max-w-[250px]' : ''} transition-max-w ease-in-out duration-200`}>
    <ul className="flex justify-around gap-y-2 sm:sticky sm:top-[106px] sm:min-h-[calc(100vh-130px)] sm:flex-col">
      ...
      to='/dashboard'
         className={({isActive})=>`flex flex-col items-center justify-center rounded-xl py-1 sm:w-full sm:flex-row sm:border sm:p-1.5 sm:hover:bg-red-600 sm:hover:text-white ${isActive ? "border-white bg-red-600 text-white" : "border-black"} sm:group-hover:justify-start sm:group-hover:px-4 lg:justify-start lg:px-4`}>
          ...
          <span className={`block sm:hidden sm:group-hover:inline ${!path ? 'lg:inline' : ''  }`}>Dashboard</span>
      ...
      <button
         ...
         className={`flex flex-col items-center justify-center rounded-xl py-1 sm:w-full sm:flex-row sm:border sm:p-1.5 sm:hover:bg-red-600 border-black sm:hover:text-white sm:group-hover:justify-start sm:group-hover:px-4 lg:justify-start lg:px-4 disabled `}
         onClick={handleLogout} 
          ...
          <span className={`block sm:hidden sm:group-hover:inline ${!path ? 'lg:inline' : ''  }`}>Logout</span>
