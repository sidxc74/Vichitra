...
function Navbar() {
  ...
  return (
    ...
    <nav className="mx-auto flex  max-w-full  justify-between  py-2">
      ...
      <button className="group peer ml-4 flex w-6 shrink-0 flex-wrap gap-y-1.5 sm:hidden">
        ...
        <span className="block h-[2px] w-2/3 bg-black group-hover:bg-red-600"></span>
        <span className="block h-[2px] w-full bg-black group-hover:bg-red-600"></span>
      </button>
      <div
        ...
        <ul className="my-4 flex w-full flex-wrap gap-2 px-4 sm:hidden">
          <li className="w-full">
            <button
              className="flex w-full items-center justify-start gap-x-4 border border-white px-4 py-1.5 text-left hover:bg-red-600 hover:text-white focus:border-red-600 focus:bg-red-600 focus:text-white">
        ...
        <div className="mb-8 mt-auto flex w-full flex-wrap gap-4 px-4 sm:mb-0 sm:mt-0 sm:items-center sm:px-0">
          ...
          :
          <>
          <button className="w-full  px-3 py-2 hover:text-red-600 text-black sm:w-auto sm:bg-transparent"
            onClick={() => {
              navigate('/login')
            }}
          >Log in</button>
          <button
            className="mr-1 w-full bg-red-600 px-3 py-2 text-center font-bold text-white shadow-[5px_5px_0px_0px_#4f4e4e] transition-all duration-150 ease-in-out active:translate-x-[5px] active:translate-y-[5px] active:shadow-[0px_0px_0px_0px_#4f4e4e] sm:w-auto"
            onClick={() => {
              navigate('/register')
            }}
            >
