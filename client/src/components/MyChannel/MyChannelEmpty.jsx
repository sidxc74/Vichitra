...
function MyChannelEmpty({ setUploadVideo }) {
  ...
  return (
    <div className="flex justify-center p-4">
      <div className="w-full max-w-sm text-center">
        ...
        <button 
          className="mt-4 inline-flex items-center gap-x-2 bg-red-600 px-3 py-2 font-semibold text-white"
          onClick={handleClick}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
